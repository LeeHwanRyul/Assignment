...
class Q_Learning:
    ...
    def save_model(self, filename="q_table_q_learning.pkl"):
        with open(filename, "wb") as f:
            pickle.dump(self.q_table, f)
        print(f"[INFO] Q-table saved to {filename}")

    def load_model(self, filename="q_table_q_learning.pkl"):
    ...
    def train(self):
        ...
        for episode in range(self.num_episodes):
            ...
            while not done:
                ...
                td_error = reward + self.gamma * np.max(self.q_table[next_observation]) - self.q_table[observation][
                    action]
        ...
        current_dir = os.path.dirname(os.path.abspath(__file__))
        save_path = os.path.join(current_dir, "q_table_q_learning.pkl")
